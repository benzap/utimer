...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__50503 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,((function (G__50503){
return (function (p1__50502_SHARP_){
return cljs.core.subs.call(null,p1__50502_SHARP_,(0),(3));
});})(G__50503))
,G__50503);
} else {
return G__50503;
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__50512){
var vec__50513 = p__50512;
var t = cljs.core.nth.call(null,vec__50513,(0),null);
var pattern = cljs.core.nth.call(null,vec__50513,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__50516 = pattern;
switch (G__50516) {
case "S":
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50516)].join('')));
...
switch (G__50526__$1) {
case "millis":
return ((function (G__50526,G__50526__$1){
return (function (p1__50518_SHARP_){
return p1__50518_SHARP_.getMilliseconds();
});
;})(G__50526,G__50526__$1))

break;
case "seconds":
return ((function (G__50526,G__50526__$1){
return (function (p1__50519_SHARP_){
return p1__50519_SHARP_.getSeconds();
});
;})(G__50526,G__50526__$1))
...
case "minutes":
return ((function (G__50526,G__50526__$1){
return (function (p1__50520_SHARP_){
return p1__50520_SHARP_.getMinutes();
});
;})(G__50526,G__50526__$1))
...
case "hours":
return ((function (G__50526,G__50526__$1){
return (function (p1__50521_SHARP_){
return p1__50521_SHARP_.getHours();
});
;})(G__50526,G__50526__$1))
...
return p1__50522_SHARP_.getHours();
});
;})(G__50526,G__50526__$1))
...
return p1__50523_SHARP_.getDate();
});
;})(G__50526,G__50526__$1))
...
return p1__50524_SHARP_.getMonth();
});
;})(G__50526,G__50526__$1))
...
return p1__50525_SHARP_.getYear();
});
;})(G__50526,G__50526__$1))

break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50526__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__50528){
var vec__50529 = p__50528;
var seq__50530 = cljs.core.seq.call(null,vec__50529);
var first__50531 = cljs.core.first.call(null,seq__50530);
var seq__50530__$1 = cljs.core.next.call(null,seq__50530);
var key = first__50531;
var args = seq__50530__$1;
var G__50532 = key;
var G__50532__$1 = (((G__50532 instanceof cljs.core.Keyword))?G__50532.fqn:null);
switch (G__50532__$1) {
case "millis":
...
break;
case "ordinal-suffix":
var vec__50533 = syntax_list.call(null,(i - (1)));
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("No matching clause: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50532__$1)].join('')));
...
var d = value;
var G__50540 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__50541 = G__50540;
...
var unparser = first__50543;
var more = seq__50542__$1;
var s = "";
var d__$1 = d;
var G__50540__$1 = G__50540;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__50544 = G__50540__$1;
var seq__50545 = cljs.core.seq.call(null,vec__50544);
var first__50546 = cljs.core.first.call(null,seq__50545);
var seq__50545__$1 = cljs.core.next.call(null,seq__50545);
var unparser__$1 = first__50546;
var more__$1 = seq__50545__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__50547 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__50547,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__50547,(1),null);
var G__50550 = d__$3;
var G__50551 = more__$1;
var G__50552 = s__$3;
d__$1 = G__50550;
G__50540__$1 = G__50551;
s__$1 = G__50552;
continue;
}
break;

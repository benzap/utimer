...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__39680){
var vec__39681 = p__39680;
var _ = cljs.core.nth.call(null,vec__39681,(0),null);
var v = cljs.core.nth.call(null,vec__39681,(1),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__39684_SHARP_){
return ((p1__39684_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__39684_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__39685,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__39685;
}
});
...
var len__36173__auto___39688 = arguments.length;
var i__36174__auto___39689 = (0);
while(true){
if((i__36174__auto___39689 < len__36173__auto___39688)){
args__36180__auto__.push((arguments[i__36174__auto___39689]));

var G__39690 = (i__36174__auto___39689 + (1));
i__36174__auto___39689 = G__39690;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__36181__auto__);
});
...
var G__39687 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__39687,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__39687;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq39686){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39686));
});
...
var vec__39693 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("Can't match CSS tag: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__39693,(0),null);
var names = cljs.core.nth.call(null,vec__39693,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__39693,tag_name,names){
return (function (p1__39691_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__39691_SHARP_))){
return p1__39691_SHARP_;
} else {
return null;
}
});})(matches,vec__39693,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__39693,tag_name,names){
return (function (p1__39692_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__39692_SHARP_));
});})(matches,vec__39693,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__39696){
var vec__39697 = p__39696;
var seq__39698 = cljs.core.seq.call(null,vec__39697);
var first__39699 = cljs.core.first.call(null,seq__39698);
var seq__39698__$1 = cljs.core.next.call(null,seq__39698);
var tag = first__39699;
var content = seq__39698__$1;
...
var vec__39700 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__39700,(0),null);
var id = cljs.core.nth.call(null,vec__39700,(1),null);
var class$ = cljs.core.nth.call(null,vec__39700,(2),null);

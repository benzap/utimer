...
var temp__4657__auto___50879 = cljs.core.deref.call(null,utimer.alarm._STAR_tested_audio);
if(cljs.core.truth_(temp__4657__auto___50879)){
var old_audio_50880 = temp__4657__auto___50879;
old_audio_50880.pause();
} else {
}
...
utimer.alarm.is_playing_QMARK_ = (function utimer$alarm$is_playing_QMARK_(p__50881){
var map__50882 = p__50881;
var map__50882__$1 = ((((!((map__50882 == null)))?((((map__50882.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50882.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50882):map__50882);
var alarm = map__50882__$1;
var audio = cljs.core.get.call(null,map__50882__$1,new cljs.core.Keyword(null,"audio","audio",1819127321));
return cljs.core.not.call(null,audio.paused);
});
utimer.alarm.is_looping_QMARK_ = (function utimer$alarm$is_looping_QMARK_(p__50884){
...
utimer.alarm.set_sound_BANG_ = (function utimer$alarm$set_sound_BANG_(p__50887,src){
...
utimer.alarm.set_loop_BANG_ = (function utimer$alarm$set_loop_BANG_(p__50890,x){
...
utimer.alarm.play_BANG_ = (function utimer$alarm$play_BANG_(p__50893){
...
var _STAR_options = cljs.core.get.call(null,map__50894__$1,new cljs.core.Keyword(null,"*options","*options",-526557877));
...
utimer.alarm.stop_BANG_ = (function utimer$alarm$stop_BANG_(p__50896){

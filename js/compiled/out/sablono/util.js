...
var x__35717__auto__ = (((x == null))?null:x);
var m__35718__auto__ = (sablono.util.to_str[goog.typeOf(x__35717__auto__)]);
if(!((m__35718__auto__ == null))){
return m__35718__auto__.call(null,x);
} else {
var m__35718__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__35718__auto____$1 == null))){
return m__35718__auto____$1.call(null,x);
} else {
...
var x__35717__auto__ = (((x == null))?null:x);
var m__35718__auto__ = (sablono.util.to_uri[goog.typeOf(x__35717__auto__)]);
if(!((m__35718__auto__ == null))){
return m__35718__auto__.call(null,x);
} else {
var m__35718__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__35718__auto____$1 == null))){
return m__35718__auto____$1.call(null,x);
} else {
...
var len__36173__auto___39667 = arguments.length;
var i__36174__auto___39668 = (0);
while(true){
if((i__36174__auto___39668 < len__36173__auto___39667)){
args__36180__auto__.push((arguments[i__36174__auto___39668]));

var G__39669 = (i__36174__auto___39668 + (1));
i__36174__auto___39668 = G__39669;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__36181__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq39666){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq39666));
});
...
var vec__39670 = cljs.core.name.call(null,k).split("-");
var seq__39671 = cljs.core.seq.call(null,vec__39670);
var first__39672 = cljs.core.first.call(null,seq__39671);
var seq__39671__$1 = cljs.core.next.call(null,seq__39671);
var first_word = first__39672;
var words = seq__39671__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__39673){
var vec__39674 = p__39673;
var k = cljs.core.nth.call(null,vec__39674,(0),null);
var v = cljs.core.nth.call(null,vec__39674,(1),null);
...
return cljs.core.update.call(null,G__39677,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__39677;
}
} else {
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__35048__auto__ = x__$1.hasDomain();
